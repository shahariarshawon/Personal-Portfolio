...
const Navbar = () => {
  return (
    <div className="max-w-6xl mx-auto mt-5 rounded-4xl p-[3px] bg-gradient-to-r from-indigo-500 from-10% via-sky-500 via-30% to-emerald-500 to-90% animate-gradient-x shadow-xl ">
      <div className="navbar bg-base-100 rounded-4xl p-5">
        <div className="navbar-start">
          ...
          <div className="dropdown">
            ...
            >
              ...
              <li>
                <a href="#technology" className="relative group text-gray-800">
                  Skills
                  <span className="absolute left-0 -bottom-0.5 h-[2px] w-0 bg-black transition-all duration-300 group-hover:w-full"></span>
                </a>
              </li>
              <li>
                <a href="#education" className="relative group text-gray-800">
                  Education
                  <span className="absolute left-0 -bottom-0.5 h-[2px] w-0 bg-black transition-all duration-300 group-hover:w-full"></span>
                </a>
              </li>
        ...
        <div className="navbar-center hidden lg:flex">
          <ul className="space-x-6 flex">
            ...
            <li>
              <a href="#technology" className="relative text-xl group">
                Skills
                <span className="absolute left-0 -bottom-1 h-[2px] w-0 bg-gray-400 transition-all duration-300 group-hover:w-full"></span>
              </a>
            </li>

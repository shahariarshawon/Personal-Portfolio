...
const skills = [
  ...
  {
    name: "PHP",
    logo: "https://i.ibb.co/N2234C7R/new-php-logo.png",
    level: "Intermediate",
    exp: "2 years",
    color: "teal-400",
  },
  ...
  {
    name: "Vercel",
    logo: "https://icon.icepanel.io/Technology/png-shadow-512/Vercel.png",
    level: "Intermediate",
    exp: "2 years",
    color: "neutral-900",
  },
...
const colorMap = {
  "green-500":
    "hover:border-green-500 hover:ring-green-500 hover:shadow-green-500/40",
  "gray-700":
    "hover:border-gray-700 hover:ring-gray-700 hover:shadow-gray-700/40",
  "neutral-900":
    "hover:border-neutral-900 hover:ring-neutral-900 hover:shadow-neutral-900/40",
  "cyan-400":
    "hover:border-cyan-400 hover:ring-cyan-400 hover:shadow-cyan-400/40",
  "purple-500":
    "hover:border-purple-500 hover:ring-purple-500 hover:shadow-purple-500/40",
  "yellow-400":
    "hover:border-yellow-400 hover:ring-yellow-400 hover:shadow-yellow-400/40",
  "blue-600":
    "hover:border-blue-600 hover:ring-blue-600 hover:shadow-blue-600/40",
  "teal-400":
    "hover:border-teal-400 hover:ring-teal-400 hover:shadow-teal-400/40",
  "green-600":
    "hover:border-green-600 hover:ring-green-600 hover:shadow-green-600/40",
  "amber-400":
    "hover:border-amber-400 hover:ring-amber-400 hover:shadow-amber-400/40",
  "orange-500":
    "hover:border-orange-500 hover:ring-orange-500 hover:shadow-orange-500/40",
  "indigo-500":
    "hover:border-indigo-500 hover:ring-indigo-500 hover:shadow-indigo-500/40",
  "blue-500":
    "hover:border-blue-500 hover:ring-blue-500 hover:shadow-blue-500/40",
};
